        ...
        <form method="POST" action="{{ route('vendor.items.update', $item) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="number" name="price_jam" value="{{ old('price_jam', $item->price_jam) }}" min="0" step="500"
                ...
                <div>
                    ...
                    <input type="number" name="price_bulan" value="{{ old('price_bulan', $item->price_bulan) }}" min="0" step="500"
